...
# Wed May 29 15:45:51 CEST 2024
# DO NOT MODIFY


# 
# simple_mm_register "Simpe Avalon RegisterMemory Mapped Register" v1.0
#  2024.05.29.15:45:51
# 
# 
...
set_module_property DISPLAY_NAME "prog GPIO"
...
# Entrée pour l’adresse venant du bus Avalon
add_interface_port avalon_slave_0 avs_address address Input 32

#
# Ajout des PIO Inputs/Outputs et IRQ
#
add_interface pio conduit end
set_interface_property pio ENABLED true
add_interface_port pio pio_i pio_i Input 32
add_interface_port pio pio_o pio_o Output 32
add_interface_port pio irq irq Output 1
